...
public class Exercise1Test extends PetDomainForKata
{
    ...
    public void getPeopleWithCats()
    {
        ...
        MutableList<Person> peopleWithCats = this.people.select(person -> {return person.hasPet(PetType.CAT);});  // this.people...
    ...
    public void getPeopleWithoutCats()
    {
        ...
        MutableList<Person> peopleWithoutCats = this.people.select(person -> {return !person.hasPet(PetType.CAT);});  // this.people...
